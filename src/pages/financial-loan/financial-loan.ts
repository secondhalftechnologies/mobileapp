...
/**
 * Generated class for the FinancialLoanPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-financial-loan',
  templateUrl: 'financial-loan.html',
})
export class FinancialLoanPage {
	...
	ionViewDidLoad() {
		console.log('ionViewDidLoad FinancialLoanPage');
		...
		this.api.get('loans/'+ this.farmer_id)
		.map(res => res.json())
		.subscribe(
			data => {
				if(data.success){
	...
	addnew(){
		...
		this.navCtrl.push('FinancialLoanAddPage', {
